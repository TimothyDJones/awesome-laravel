...
- [Burnmsg](https://burnmsg.com/) - Simple self-destructing, encrypted messaging application built on Laravel.  [Open-source, self-hosted version available on Github.](https://github.com/ezynda3/burnmsg)
