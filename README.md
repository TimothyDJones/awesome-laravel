...
- [Sharp](https://github.com/code16/sharp/) - Sharp 4.0 is an open source content management framework, quite similar (but older) to Nova. It can handle entities lists and form, validation, commands, filters, search, authorization, ... without writing a single line of front code, with full control on the back. \[12/31/2018\]
