...
- [Laravel-QuickStart](https://github.com/developervijay7/laravel-quickstart) - Laravel Quickstart is a boilerplate for Laravel Application with typical packages preinstalled and configured to extend a full-fledged application. We tried to make it as minimal as possible.
