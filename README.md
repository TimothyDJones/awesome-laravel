...
A curated list of delightful [Laravel](https://laravel.com/) PHP framework [packages](#packages) and [resources](#resources).  Inspired by other [awesome lists](https://github.com/bayandin/awesome-awesomeness).
...
- [Laravel Collective](https://laravelcollective.com/) - Maintainers of components removed from core Laravel framework, including annotations, remote (SSH), and forms/HTML.
- [Packagist](https://packagist.org/) - Official directory of Laravel (and other Composer-installable) packages.
- [Packalyst](http://packalyst.com/) - Directory of Laravel packages (semi-official).

### Algorithms/Data Structures
- [Baum](http://etrepat.com/baum/) - An implementation of the [Nested Set](https://en.wikipedia.org/wiki/Nested_set_model) pattern for Laravel 4's Eloquent ORM.
...
- [jwt-auth](https://github.com/tymondesigns/jwt-auth) - [JSON Web Token](https://en.m.wikipedia.org/wiki/JSON_Web_Token) authentication package for Laravel. \[06/11/2015\]
...
- [Laravel 5 Boilerplate](https://github.com/repeater09/Laravel-5-Boilerplate) - Laravel 5 application boilerplate built with [Skeleton](http://getskeleton.com/), [Sidr](https://www.berriart.com/sidr/), and [Fontastic](http://fontastic.me/).
- [Laravel 5 Boilerplate](https://github.com/rappasoft/Laravel-5-Boilerplate) - Responsive Laravel 5 application template with [Bootstrap 3](http://getbootstrap.com/), [HTML 5 Boilerplate](https://html5boilerplate.com/), [Font Awesome](http://fortawesome.github.io/Font-Awesome/), and more.
...
- [Laravel Doctrine](http://www.laraveldoctrine.org/) - A package that tightly integrates the [Doctrine](http://www.doctrine-project.org/) ORM with Laravel. \[09/10/2015\]
...
- [Laravel 5 Repository](https://github.com/andersao/l5-repository) - Package for the implementing the [repository design pattern](http://www.sitepoint.com/repository-design-pattern-demystified/) to abstract database layer of your application. \[08/16/2015\]
...
- [Larasupport](http://irazasyed.github.io/larasupport/) - Provides some missing helpers to [Lumen](https://lumen.laravel.com/) and allows Laravel packages to be used with Lumen. \[06/08/2015\]
...
- [Laravel Backup](https://github.com/spatie/laravel-backup) - Artisan extension that allows you to backup your application and database into a ZIP archive.
...
- [Laravel IDE Helper](https://github.com/barryvdh/laravel-ide-helper) - Adds auto-complete support for Laravel syntax to a variety of IDEs and text editors, including [Aptana Studio](http://www.aptana.com/), [Eclipse](http://www.eclipse.org/), [PHP Storm](http://www.jetbrains.com/phpstorm/), and more.
...
- [Environment](https://github.com/cekurte/environment) - A simple library to increase the power of your environment variables.

### E-commerce
- [Aimeos](https://aimeos.org/index.php) - Complete e-commerce/web shop package with support for product catalogs, shopping, checkout, payment, and order management. \[04/29/2015\]
...
- [dd](https://github.com/larapack/dd) - Laravel 4 helper similar to [new `dd` from Laravel 5](https://laravel-news.com/2014/12/laravel-5-dd-gets-upgrade/).
- [Eloquent Sluggable](https://github.com/cviebrock/eloquent-sluggable) - Extends Eloquent to include a "sluggable" trait for easy generation of [slugs](https://en.wikipedia.org/wiki/Semantic_URL#Slug).
...
- [Graham Campbell's Packages](https://gjcampbell.co.uk/) - Variety of excellent packages for extending Laravel 4/5 functionality.
...
- [Laravel Auto Presenter](https://github.com/laravel-auto-presenter/laravel-auto-presenter) - Automatically decorates (applies formatting to) model objects bound to views during the view render process.
...
- [Laravel Javascript Routes](https://github.com/fedeisas/laravel-4-js-routes) - Package to allow simple matching of Laravel routes to JavaScript/jQuery on client side.
...
- [Laravel Form Validator](https://github.com/GrandadEvans/laravel-form-validator) - An extension of [way/generators](https://github.com/JeffreyWay/Laravel-4-Generators) for setting up form validators.
...
- [Laravel 4 on a shared host](https://driesvints.com/blog/laravel-4-on-a-shared-host) - Shared hosting can be difficult to set up for Laravel. Here are some good tips.
...
- [Tinkering with Tinker Like an Artisan](http://blog.enge.me) - I think Tinker is one of the greatest features in all of Laravel!
...
- [Using Laravel Homestead as Your Development Environment](http://blog.teamtreehouse.com/using-laravel-homestead-development-environment) - Excellent, detailed tutorial on setting up [Vagrant](https://www.vagrantup.com/) and using it with Laravel [Homestead](http://laravel.com/docs/homestead) for development.
...
- [Limiting 'Belongs To Many' database queries with Pivot table values](https://stephen.rees-carter.net/thought/limiting-belongs-to-many-database-queries-with-pivot-table-values-in-laravel) - Also explains how to access additional attributes on [pivot tables](http://laravel.com/docs/4.2/eloquent#many-to-many).
...
- [Laravel Hunt](https://laravel-hunt.com/) - A forum/directory for Laravel tutorials, examples, resources, etc. in the style of [Product Hunt](https://www.producthunt.com/). \[06/08/2015\]
...
- [Laravel Tricks](http://laravel-tricks.com/) - Code snippets, best practices, and tips for Laravel development.
...
- [AccountsPortal](https://www.accountsportal.com/) - Hosted online accounting application with support for invoicing, books and accounts. \[04/20/2015\]
- [Asgard CMS](https://asgardcms.com/) - CMS built with Laravel with goals of modularity, multi-language support, and ease of installation.
...
- [BootstrapCMS](https://github.com/BootstrapCMS/CMS) - Comprehensive CMS built with Laravel using [Sentry](https://cartalyst.com/manual/sentry/2.1) for user management/authentication.
- [Bumble CMS](https://bumblecms.com/) - CMS platform for Laravel framework with focus on simplicity. \[09/04/2015\]
...
- [Cachet](https://cachethq.io/) - A single-site, alternative to https://www.statuspage.io/ written in PHP with the Laravel project, supporting both SQLite and MySQL databases.
...
- [Filegr.am](http://filegr.am/buckets/n/zWQW54SO) - Share files up to 1GB for 24 hours with no sign up or installation. \[07/31/2015\]
...
- [Invoice Ninja](https://www.invoiceninja.com/) - Online small business invoicing platform with free plan up to 500 clients.  [Open-source, self-hosted version available on Github.](https://github.com/invoiceninja/invoiceninja)
...
- [Snipe-IT](https://snipeitapp.com/) - A free open source (source code [here](https://github.com/snipe/snipe-it)) IT asset/license management system built in PHP on Laravel 4.2 and Bootstrap 3. \[08/13/2015\]
...
- [Thermosis Framework](http://framework.themosis.com/) - [WordPress](https://wordpress.org/) framework that embeds Laravel to build complex applications.
...
### Books
- *[Easy Laravel 5: A Hands On Introduction Using a Real-World Project](http://www.easylaravelbook.com/)* - W. Jason Gilmore's book on building applications with Laravel framework.
...
- [Laravel Errors](http://eecs.mines.edu/Courses/csci445/ASSIGN/laravel.html#errors) - Good list of common Laravel errors and tips about typical causes.
...
- [Kwiki](https://github.com/ryanwinchester/kwiki) - Markdown-based wiki/blogging platform built on [Lumen](http://lumen.laravel.com/) that uses flat files (no database). \[06/16/2015\]
...
- [Laravel Bootstrap](https://github.com/davzie/laravel-bootstrap) - A Laravel 4.1 PHP 5.4 CMS using Bootstrap 3, built with [SOLID](https://en.wikipedia.org/wiki/SOLID_%28object-oriented_design%29) principles.
...
- [Laravel.io](https://github.com/LaravelIO/laravel.io) - The source code for the [Laravel.IO](http://laravel.io/forum) website, including comprehensive tests.
...
- [Andreas Lutro](https://www.lutro.me/)
...
- [Belar Design](https://belardesign.com/category/dev/laravel/)
...
- [CODETutorial.io](https://www.codetutorial.io/tutorial/laravel-5/) \[08/06/2015\]
...
- [Cubet Techno Labs](http://cubettech.com/blog/category/laravel-frame-work/) \[04/27/2015\]
...
- [developed.be](http://developed.be/languages/frameworks/lavarel/)
...
- [Duilio Palacios](https://styde.net/) \[04/12/2015\]
- [Dunebook](http://www.dunebook.com/category/useful-resources-for-laravel/) \[08/08/2015\]
...
- [Full Stack Blog](http://www.fullstack4u.com/category/laravel/) \[07/21/2015\]
...
- [Isaac Castillo](http://icemancast.com) \[09/10/2015\]
...
- [James Brooks](https://james-brooks.uk/)
...
- [Laravel Coder](https://sheepy85.wordpress.com/)
...
- [Mack Hankins](http://mackhankins.com/blog/)
...
- [Stephen Rees-Carter](https://stephen.rees-carter.net/tag/laravel)
...
- [Taha Shashtari](http://taha-sh.com) \[10/07/2015\]
...
- [The Reluctant Web Developer](https://thereluctantdeveloper.com/category/laravel)
...
- [Tommy Ku](https://blog.tommyku.com/)
...
- [WebDevTuts](https://webdevtuts.co.uk/tag/laravel/) \[07/13/2015\]
- [Weblint4u](http://weblint4u.com/category/laravel/)
- [Websanova](https://websanova.com/blog) \[09/23/2015\]
...
- [Learn Laravel Reddit](https://www.reddit.com/r/learnlaravel/) - Good forum for Laravel beginners (however, not very active).
...
- [Laravel News](https://laravel-news.com/) - Popular newsletter with updates from the Laravel community including excellent profiles of community members.
...
- [LaraJobs](https://larajobs.com/) - The best place to post your PHP, Laravel, or technical guru jobs.
- [Laramap](https://laramap.com/) - Interactive worldwide map of Laravel developers. \[06/08/2015\]
...
- [Laragon](https://laragon.org/) - Open-source toolkit for setting up Laravel development environment on Windows.
...
- [Laravel Docker](https://github.com/SteveAzz/laravel-docker) - [Docker](https://www.docker.com/) configuration for building Laravel development environment. \[10/30/2015\]
...
- [Scotch Box](https://box.scotch.io/) - A complete [LAMP](https://en.m.wikipedia.org/wiki/LAMP_%28software_bundle%29) [Vagrant](https://www.vagrantup.com/) box with PHP 5.5, Laravel installer, and Node.JS front-end tools. \[05/22/2015\]
